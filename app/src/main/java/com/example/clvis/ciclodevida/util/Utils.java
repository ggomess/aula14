...
package com.example.clvis.ciclodevida.util;
...
public class Utils {
    ...
    private static com.example.clvis.ciclodevida.util.StatusTracker mStatusTracker = com.example.clvis.ciclodevida.util.StatusTracker.getInstance();
